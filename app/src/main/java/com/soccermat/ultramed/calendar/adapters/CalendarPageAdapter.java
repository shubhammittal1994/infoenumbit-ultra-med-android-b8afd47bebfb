...
import com.soccermat.ultramed.calendar.extensions.CalendarGridView;
import com.soccermat.ultramed.calendar.listeners.DayRowClickListener;
...
public class CalendarPageAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Log.v("akram", "page month " + mCalendarProperties.getCurrentDate().getTime());
